...
const AnalysisCard: React.FC<AnalysisCardProps> = ({ analysis, isLoading, error, onAnalyze }) => {
    ...
    return (
        <div className="bg-[#2A2D3A] p-6 rounded-xl shadow-lg border border-slate-700/50">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4">
                ...
                <button
                    ...
                    disabled={isLoading}
                    className="flex items-center justify-center w-auto px-5 py-2.5 bg-indigo-600 text-white font-semibold rounded-lg shadow-md hover:bg-indigo-700 disabled:bg-indigo-500/70 disabled:cursor-not-allowed transition-colors duration-200"
                >
                    {isLoading ? (
                        ...
                        <>
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
                                <path d="M10 3.5a1.5 1.5 0 013 0V4a1 1 0 001 1h3a1 1 0 011 1v2a1 1 0 01-1 1h-3a1 1 0 00-1-1V6.5a1.5 1.5 0 01-3 0V6a1 1 0 00-1-1H6a1 1 0 01-1-1V3a1 1 0 011-1h3a1 1 0 001-1V1.5a1.5 1.5 0 013-0V2a1 1 0 001 1h3a1 1 0 011 1v2a1 1 0 01-1 1h-3a1 1 0 00-1 1v.5a1.5 1.5 0 01-3 0V14a1 1 0 00-1 1h-3a1 1 0 01-1-1v-2a1 1 0 011-1h3a1 1 0 001-1v-.5a1.5 1.5 0 013-0V10a1 1 0 00-1-1H6a1 1 0 01-1-1V7a1 1 0 011-1h3a1 1 0 001-1V3.5z" />
                            </svg>
                            Analyze Names
                        </>
                    )}
            ...
            <div className="mb-4">
                ...
                <textarea
                    ...
                    rows={4}
                    className="w-full px-4 py-3 bg-[#1E1F29] border border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 text-gray-200 transition-colors disabled:bg-gray-700/50"
                    value={instruction}
            ...
            {!analysis && !isLoading && !error && (
                 <div className="text-center py-8 text-gray-400 border-t border-slate-700 mt-4">Adjust the instructions if needed and click "Analyze Names" to generate insights.</div>
            )}
            ...
            {analysis && (
                <div className="mt-4 pt-4 border-t border-slate-700 grid md:grid-cols-2 gap-6">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <p className="text-gray-400 bg-slate-900/50 p-4 rounded-md border border-slate-700">{analysis.analysisSummary}</p>
                    </div>
                </div>
            )}
        </div>
